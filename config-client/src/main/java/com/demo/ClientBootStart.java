...
public class ClientBootStart {
	...
	public void refreshProperties() {
		// System.out.println("<<<<<<<< currentTime="+new
		...
		for (String property : updatedProperties) {
			System.out.println(String.format("Thread-%s property属性刷新，key=%s val=%s", Thread.currentThread().getName(),
					property, env.getProperty(property)));
		}
	}
